// Example : optical flow demo (Farnback)
...
int main( int argc, char** argv )
{
  ...
  Mat img, gray, prevgray, flow, cflow;  // image objects
  VideoCapture cap; // capture object

  const string windowName = "Optical Flow"; // window name
